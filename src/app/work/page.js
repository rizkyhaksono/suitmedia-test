    ...
    <>
      ...
      <div className="relative mx-auto max-w-full">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-black bg-opacity-50 flex flex-col justify-center items-center text-center text-white">
          <h1 className="text-4xl font-bold mb-4 hover:text-primary transition duration-300 ease-in-out">Our Work</h1>
          <p className="text-lg hover:text-primary transition duration-300 ease-in-out">We make something you love</p>
        </div>
      </div>
      <FooterComponent />
    </>
